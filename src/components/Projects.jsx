  ...
  const projects = [
    {
      title: "Inventro",
      duration: "2026",
      description: "Smart Inventory Management with Real-Time Automation. Inventro is an intelligent inventory management system designed to streamline item tracking, organization, and stock monitoring. It leverages automation and real-time updates to improve efficiency and reduce manual errors in inventory workflows. Impact: Reduces manual inventory errors and improves operational efficiency by introducing automation into traditional inventory systems.",
      tags: ["JavaScript", "HTML", "CSS"],
      github: "https://github.com/Mutthuram03/Inventro.git",
    ...
    },
    {
      title: "Travel Buddy",
      duration: "2026",
      description: "Your Smart Travel Companion for Exploring Tamil Nadu. Travel Buddy is a location-focused web application that helps users plan trips, explore destinations, and manage itineraries across Tamil Nadu. It provides personalized travel suggestions and simplifies trip planning through an intuitive interface. Impact: Helps users discover hidden gems and plan efficient trips, enhancing travel experiences with localized recommendations.",
      tags: ["JavaScript", "HTML", "CSS"],
      github: "https://github.com/Mutthuram03/Travel_Buddy.git",
      gradient: "from-sky-500 to-indigo-600",
      image: "https://images.unsplash.com/photo-1524661135-423995f22d0b?w=1200&auto=format&fit=crop&q=60",
    },
     {
      title: "FarmStack",
